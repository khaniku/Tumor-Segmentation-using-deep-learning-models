...
config["test_dir"] = "./drive/MyDrive/Tumor\ Segmentation/data/BraTS2020_ValidationData/MICCAI_BraTS2020_ValidationData"
...
config["data_file"] = "./Tumor-Segmentation-and-Detection-using-deep-learning-models/U-net/src/unet3d/data/model/brats2018_data.h5"
config["data_file_test"] = "./Tumor-Segmentation-and-Detection-using-deep-learning-models/U-net/src/unet3d/data/model/brats2018_data_test.h5"
...
config["training_file"] = "./Tumor-Segmentation-and-Detection-using-deep-learning-models/U-net/src/unet3d/data/model/isensee_training_ids.pkl"
config["validation_file"] = "./Tumor-Segmentation-and-Detection-using-deep-learning-models/U-net/src/unet3d/data/model/isensee_validation_ids.pkl"
config["test_file"] = "./Tumor-Segmentation-and-Detection-using-deep-learning-models/U-net/src/unet3d/data/model/isensee_test_ids.pkl"
